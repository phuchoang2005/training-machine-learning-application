...
| **2. Component Architecture**  | Hệ thống nên tách thành những module nào: Project Service, Job Service, Queue Service, Docker Runner, Log Service, Artifact Service, Notification Service? | **High-Level Component Diagram**                          |
...
| **4. Training Job Flow**       | Từ lúc user bấm Train đến khi container chạy, stream log, lưu artifact, gửi email diễn ra thế nào?                                                         | **Training Execution Sequence Diagram**                   |
...
| **14. Data Model**             | Cần những bảng nào: users, projects, jobs, job_logs, artifacts, model_versions, config_snapshots, audit_logs, notifications?                               | **ERD / Logical Data Model**                              |
